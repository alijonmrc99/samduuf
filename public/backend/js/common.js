(function ($) {
    ...
    $("#jsGrid").jsGrid({
        ...
        controller: {
            ...
            insertItem: function (item) {
                return $.ajax({
                    type: "POST",
                    url: "/admin/social/insertSocials",
                    data: item,
                    headers: {
            ...
            updateItem: function (item) {
                $.ajax({
                    method: 'POST',
                    url: "/admin/social/updateSocials",
                    dataType: "json",
                    data: item,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            deleteItem: function (item) {
                return $.ajax({
                    type: 'DELETE',
                    url: "/admin/social/deleteSocials",
                    dataType: "json",
                    data: item,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        fields: [
            {name: "id", type: "text", width: 50, readOnly: true, align: 'center'},
            {name: "name", type: "text", width: 100, validate: 'required', align: 'center'},
            {name: "link", type: "text", width: 180, validate: 'required', align: 'center'},
            {type: "control"}
        ]
    });
    ...
    $("#jsGridSkills").jsGrid({
        ...
        fields: [
            {name: "id", type: "number", width: 50, readOnly: true, align: 'center'},
            {name: "name", type: "text", width: 150, validate: 'required', align: 'center'},
            {name: "percent", type: "number", width: 100, validate: 'required', align: 'center'},
            {type: "control"}
        ]
    });

    let typeItems = [];
    typeItems[1] = 'Experience';
    typeItems[2] = 'Education';
    $("#jsGridResumes").jsGrid({
        width: "100%",
        inserting: true,
        editing: true,
        sorting: true,
        ...
        controller: {
            ...
            insertItem: function (item) {
                return $.ajax({
                    type: "POST",
                    url: "/admin/resume/insertResumes",
                    data: item,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    }
            ...
            updateItem: function (item) {
                ...
                $.ajax({
                    method: 'POST',
                    url: "/admin/resume/updateResumes",
                    dataType: "json",
                    data: item,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            deleteItem: function (item) {
                return $.ajax({
                    type: 'DELETE',
                    url: "/admin/resume/deleteResumes",
                    dataType: "json",
                    data: item,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        fields: [
            {name: "id", type: "number", width: 25, readOnly: true, align: 'center'},
            {name: "position", type: "text", width: 50, validate: 'required', align: 'center'},
            {name: "place_name", type: "text", width: 50, validate: 'required', align: 'center'},
            {name: "period", type: "text", width: 50, validate: 'required', align: 'center'},
            {name: "description", type: "textarea", width: 100, validate: 'required', align: 'center'},
            {name: "type", type: "select", width: 50, validate: 'required', align: 'center', items: typeItems},
            {type: "control"}
        ]
    });

    $("#jsGridPortfolios").jsGrid({
        width: "100%",
        inserting: true,
        editing: true,
        sorting: true,
        ...
        controller: {
            loadData: function (filter) {
                return $.ajax({
                    url: "/admin/portfolio/getPortfolios",
                    dataType: "json"
                });
            },
            ...
            insertItem: function (insertingItem) {
                ...
                formData.append("image", insertingItem.image);
                formData.append("title", insertingItem.title);
                formData.append("project", insertingItem.project);
                formData.append("client", insertingItem.client);
                formData.append("languages", insertingItem.languages);
                formData.append("description", insertingItem.description);
                return $.ajax({
                    type: "POST",
                    url: "/admin/portfolio/insertPortfolios",
                    data: formData,
                    processData: false,
                    contentType: false,
                    headers: {
            ...
            updateItem: function (item) {
                ...
                formData.append("languages", item.languages);
                formData.append("description", item.description);
                console.log(item.image);
                return $.ajax({
                    type: "POST",
                    url: "/admin/portfolio/updatePortfolios",
                    data: formData,
                    processData: false,
                    contentType: false,
                    headers: {
            ...
            deleteItem: function (item) {
                return $.ajax({
                    type: 'DELETE',
                    url: "/admin/portfolio/deletePortfolios",
                    dataType: "json",
                    data: item,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        fields: [
            {name: "id", type: "number", width: 25, readOnly: true, align: 'center'},
            {name: "title", type: "text", width: 50, validate: 'required', align: 'center'},
            {name: "project", type: "text", width: 50, validate: 'required', align: 'center'},
            {name: "client", type: "text", width: 50, validate: 'required', align: 'center'},
            {name: "languages", type: "text", width: 50, validate: 'required', align: 'center'},
            {name: "description", type: "textarea", width: 100, validate: 'required', align: 'center'},
            {
                name: "image",
                itemTemplate: function (val, item) {
                    return $("<img>").attr("src", '/' + val).css({width: 150});
                },
...
//------------- Select 2 -------------//
    $('.selectRoles').select2({placeholder: 'Select roles'});
