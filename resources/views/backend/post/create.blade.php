    ...
    <div class="col-12 col-xl-12">
        <div class="card redial-border-light redial-shadow mb-4">
            <div class="card-body">
                ...
                <form method="post"
                      action="{{  route('admin.post.create')  }}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" required>
                                    ...
                                    <option value="1" {{old('type') == 1 ? 'selected' : ''}}>News(yangilik)</option>
                                    <option value="2" {{old('type') == 2 ? 'selected' : ''}}>Ad(E'lon)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <div class="form-group" style="margin-top: 32px;">
                                <input type="checkbox" id="checkbox1" name="is_active" checked>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="image" id="form-image" value="{{old('image')}}" hidden>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" name="title_uz" class="form-control"
                                               value="{{old('title_uz')}}" data-text-limit="128" data-output-id="validationLimitsTitle" onkeyup="inputValidate(this)">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" name="title_kuz" class="form-control"
                                               value="{{old('title_kuz')}}" data-text-limit="128" data-output-id="validationLimitsTitle" onkeyup="inputValidate(this)">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="identity3" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <input type="text" name="title_ru" class="form-control" value="{{old('title_ru')}}" data-text-limit="128" data-output-id="validationLimitsTitle" onkeyup="inputValidate(this)">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="identity4" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <input type="text" name="title_en" class="form-control" value="{{old('title_en')}}" data-text-limit="128" data-output-id="validationLimitsTitle" onkeyup="inputValidate(this)">
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" name="short_content_uz" class="form-control"
                                               value="{{old('short_content_uz')}}" data-text-limit="256" data-output-id="validationLimitsShortContent" onkeyup="inputValidate(this)">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" name="short_content_kuz" class="form-control"
                                               value="{{old('short_content_kuz')}}" data-text-limit="256" data-output-id="validationLimitsShortContent" onkeyup="inputValidate(this)">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="identity33" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <input type="text" name="short_content_ru" class="form-control"
                                           value="{{old('short_content_ru')}}" data-text-limit="256" data-output-id="validationLimitsShortContent" onkeyup="inputValidate(this)">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="identity44" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <input type="text" name="short_content_en" class="form-control"
                                           value="{{old('short_content_en')}}" data-text-limit="256" data-output-id="validationLimitsShortContent" onkeyup="inputValidate(this)">
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <textarea name="content_uz"
                                                  class="form-control my-editor">{{old('content_uz')}}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <textarea name="content_kuz"
                                                  class="form-control my-editor">{{old('content_kuz')}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="id3" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <textarea name="content_ru"
                                              class="form-control my-editor">{{old('content_ru')}}</textarea>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="id4" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <textarea name="content_en"
                                              class="form-control my-editor">{{old('content_en')}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
