<nav id="sidebar" class="card redial-border-light px-2 mb-4">
    <div class="sidebar-scrollarea">
        <ul class="metismenu list-unstyled mb-0" id="menu">
            ...
            <li><a href="{{route('admin.menu')}}"><i class="icofont icofont-navigation-menu"></i> Menu</a></li>
            <li><a href="{{route('admin.page')}}"><i class="icofont icofont-page"></i> Page</a></li>
            <li><a href="{{route('admin.post')}}"><i class="icofont icofont-news"></i> Post</a></li>
