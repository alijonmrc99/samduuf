                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" name="short_content_uz" class="form-control"
                                               value="{{old('short_content_uz')}}" data-text-limit="512" data-output-id="validationLimitsShortContent" onkeyup="inputValidate(this)">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" name="short_content_kuz" class="form-control"
                                               value="{{old('short_content_kuz')}}" data-text-limit="512" data-output-id="validationLimitsShortContent" onkeyup="inputValidate(this)">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="identity33" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <input type="text" name="short_content_ru" class="form-control"
                                           value="{{old('short_content_ru')}}" data-text-limit="512" data-output-id="validationLimitsShortContent" onkeyup="inputValidate(this)">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="identity44" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <input type="text" name="short_content_en" class="form-control"
                                           value="{{old('short_content_en')}}" data-text-limit="512" data-output-id="validationLimitsShortContent" onkeyup="inputValidate(this)">
                                </div>
                            </div>
                    ...
                    <div class="custom-tabs2">
                        ...
                        <div class="tab-content border redial-border-light" id="myTabContent">
                            <div class="tab-pane fade active show" id="id1" role="tabpanel"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <textarea name="content_uz" class="form-control my-editor">{{old('content_uz')}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="id2" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <div class="form-group">
                                        <textarea name="content_kuz" class="form-control my-editor">{{old('content_kuz')}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="id3" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                     <textarea name="content_ru" class="form-control my-editor">{{old('content_ru')}}</textarea>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="id4" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                     <textarea name="content_en" class="form-control my-editor">{{old('content_en')}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="menu_id" required>
                            ...
                            @foreach($menusOrLinks  as $menusOrLink)
                                <option
                                    value="{{$menusOrLink->id}}" {{old('menu_id') == $menusOrLink->id ? 'selected' : '' }}>
