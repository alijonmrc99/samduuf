    ...
    <div class="col-6 col-md-6">
        <div class="card redial-border-light redial-shadow mb-4">
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="{{route('admin.partner-org.update', ['id' => $org->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label class="redial-font-weight-600">Url</label>
                        <input type="text" class="form-control" placeholder="Enter Description" name="url" value="{{$org->url}}"/>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Enter desc"
                                               ...
                                               onkeyup="inputValidate(this)" value="{{$org->desc_uz}}"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Enter desc"
                                               ...
                                               onkeyup="inputValidate(this)" value="{{$org->desc_kuz}}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="id3" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <input type="text" class="form-control" placeholder="Enter desc"
                                           ...
                                           onkeyup="inputValidate(this)" value="{{$org->desc_ru}}"/>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="id4" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <input type="text" class="form-control" placeholder="Enter desc"
                                           ...
                                           onkeyup="inputValidate(this)"  value="{{$org->desc_en}}"/>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Order" name="order" value="{{$org->order}}"/>
                    </div>
                    <div class="form-group">
