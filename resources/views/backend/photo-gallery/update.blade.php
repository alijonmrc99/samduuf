    ...
    <div class="col-6 col-md-6">
        <div class="card redial-border-light redial-shadow mb-4">
            <div class="card-body">
                ...
                @endif
                <form method="POST"
                      action="{{route('admin.photo-galleries.update',['photo_gallery' => $photoGallery->id])}}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="date" class="form-control" placeholder="Enter date" name="date"
                               value="{{old('date',$photoGallery->date)}}"/>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Enter desc"
                                               ...
                                               onkeyup="inputValidate(this)"
                                               value="{{old('desc_uz',$photoGallery->desc_uz)}}"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Enter desc"
                                               ...
                                               onkeyup="inputValidate(this)"
                                               value="{{old('desc_kuz',$photoGallery->desc_kuz)}}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="id3" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <input type="text" class="form-control" placeholder="Enter desc"
                                           ...
                                           onkeyup="inputValidate(this)"
                                           value="{{old('desc_ru',$photoGallery->desc_ru)}}"/>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="id4" role="tabpanel" aria-expanded="false">
                                <div class="card-body">
                                    <input type="text" class="form-control" placeholder="Enter desc"
                                           ...
                                           onkeyup="inputValidate(this)"
                                           value="{{old('desc_en',$photoGallery->desc_en)}}"/>
                                </div>
                            </div>
