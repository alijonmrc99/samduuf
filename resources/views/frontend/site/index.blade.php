                ...
                @if($latestFiveNews)
                    @foreach($latestFiveNews as $latestFiveNew)
                        <div class="col-12 px-3 mb-2 mb-md-0">
                            <div class="card">
                                <div class="card-img"><img src="/{{$latestFiveNew->image}}" class="card-img-top" alt="card-img-top"></div>
                                <div class="card-body">
                                    <p class="date-show">
                                        <span class="date">{{ \App\Services\PostService::dateFormat($latestFiveNew->date,$locale) }}</span>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <a href="/post/{{$latestFiveNew->slug}}" class="card-link col-6 text-center te py-2 ">Batafsil</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                @if($latestFiveAds)
                    @foreach($latestFiveAds as $latestFiveAd)
                        <div class="col-12 px-3 mb-2 mb-md-0">
                            <div class="card">
                                <div class="card-img"><img src="/{{$latestFiveAd->image}}" class="card-img-top" alt="card-img-top"></div>
                                <div class="card-body">
                                    <p class="date-show">
                                        <span class="date">{{ \App\Services\PostService::dateFormat($latestFiveAd->date,$locale) }}</span>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <a href="/post/{{$latestFiveAd->slug}}" class="card-link col-6 text-center te py-2 ">{{__('data.read-more')}}...</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-8 video">
                    <div class="play-btn-box">
                        <div class="play-button"><svg width="20" height="25" viewBox="0 0 20 25" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class="row useful">
                    <div class="col-3 px-2">
                        <a href="https://constitution.uz/oz">
                            <img width="100%"
                                src="https://www.samdu.uz/upload/images/6132eeaa8700d-6132eeaa8700f-6132eeaa87010-6132eeaa87011.jpg"
                                alt="uzedu">
                            <span class="useful-text p-3">{{__('data.useful-sites-names.govuz')}}</span>
                        </a>
                    </div>
                    <div class="col-3 px-2">
                        <a href="https://edu.uz/uz">
                            <img width="100%"
                                src="https://www.samdu.uz/upload/images/6132ead0207d3-6132ead0207d5-6132ead0207d6-6132ead0207d7.jpg"
                                alt="uzedu">
                            <span class="useful-text p-3">{{__('data.useful-sites-names.eduuz')}}</span>
                        </a>
                    </div>
                    <div class="col-3 px-2">
                        <a href="https://my.gov.uz/oz">
                            <img width="100%"
                                src="https://www.samdu.uz/upload/images/6132f568a518f-6132f568a5190-6132f568a5191-6132f568a5192.png"
                                alt="uzedu">
                            <span class="useful-text p-3">{{__('data.useful-sites-names.mygov')}}</span>
                        </a>
                    </div>
                    <div class="col-3 px-2">
                        <a href="https://uza.uz/uz">
                            <img width="100%"
                                src="https://www.samdu.uz/upload/images/6132ef33ee108-6132ef33ee109-6132ef33ee10a-6132ef33ee10b.png"
                                alt="uzedu">
                            <span class="useful-text p-3">{{__('data.useful-sites-names.uza')}}</span>
                        </a>
                    </div>
                    <div class="col-3 px-2">
                        <a href="https://lex.uz/uz/">
                            <img width="100%" src="{{asset('frontend/img/lex_uz.jpg')}}" alt="uzedu">
                        <span class="useful-text p-3">{{__('data.useful-sites-names.lexuz')}}</span>
                        </a>
                    </div>
