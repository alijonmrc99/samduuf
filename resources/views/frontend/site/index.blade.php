...
<main>
                    ...
                    <div id="video" class="">
                        ...
                        <div class="ifreme-box">
                            <svg class="close-btn" width="57" height="57" viewBox="0 0 57 57" fill="none"
                                ...
                                <defs>
                                    <filter id="filter0_d_54_6" x="6.10352e-05" y="0" width="56.0075"
                                        height="56.8828" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                            ...
                            <iframe id="iframe" width="1280" height="720" title="{{ $videoClip->title }}"
                                frameborder="0"
        ...
        <!-- Statistics Begin -->
        <section class="bg-gray statistics-bg">
            <div class="container py-5 statistics">
                <h2 class="text-center text-white mb-4">{{ __('data.statistics') }}</h2>
                <div class="row">
                    ...
                    @foreach ($usefulSites as $usefulSite)
                        <div class="col-3 px-2">
                            <a href="{{ $usefulSite->url }}">
                                <img width="100%" src="{{ $usefulSite->image_path }}" alt="uzedu">
